...
#lecture fichier CSV
dossier_mesure_capteur = "C:/Users/fa101525/Desktop/Projet_Pollux/DATA_MESURE_1/capteur 2- site 11/capteur 2- site 11" # dossier contenant l'ensemble des fichiers 
...
st_write(obj =donnee_capteur, dsn = DB_pol_lum, layer = "donnee_capteur", delete_layer = TRUE)
